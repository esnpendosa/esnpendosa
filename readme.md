...
<div align="center">
  ...
  <p>
    ...
    <a href="mailto:asad@kangdigital.web.id">
...
<div align="center">
  <a href="https://kangdigital.web.id">
    <img src="https://img.shields.io/badge/%F0%9F%9A%80_HUBUNGI_KAMI_UNTUK_KONSULTASI_GRATIS-00B4D8?style=for-the-badge&logo=google-chrome&logoColor=white" alt="Contact" />
  </a>
</div>
...
const muhammadAsad = {
    ...
    expertise: {
        webDev: ["Laravel", "Node.js", "PHP", "JavaScript"],
        automation: ["WhatsApp Bot", "CRM System", "API Integration"],
        ai: ["AI Integration", "Smart Automation", "Machine Learning"],
        database: ["MySQL", "Database Design", "Migration"],
        devOps: ["Linux Server", "Git", "Docker", "Cloud"]
    },
    
    focus: "Menggabungkan AI ke dalam sistem bisnis otomatis",
...
<div align="center">
  ...
  <picture>
    ...
    <img alt="Snake Animation" src="https://raw.githubusercontent.com/esnpendosa/esnpendosa/output/github-contribution-grid-snake.svg" width="100%">
  </picture>
...
<div align="center">
  ...
  [![Trophies](https://github-profile-trophy.vercel.app/?username=esnpendosa&theme=nord&column=7&no-frame=true&no-bg=false&margin-w=4)](https://github.com/esnpendosa)
...
<div align="center">
  ...
  <sub>💡 <i>Always building, always learning. Let's create something amazing together!</i></sub>
